...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/AyiinXdSupport'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/AyiinXd/StreamYins')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/AyiinXd/StreamYins'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/AyiinXdSupport'),     
        ],
        [
